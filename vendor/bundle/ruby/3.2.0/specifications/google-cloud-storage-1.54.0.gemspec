# -*- encoding: utf-8 -*-
# stub: google-cloud-storage 1.54.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<google-apis-iamcredentials_v1>.freeze, ["~> 0.18"])
  s.add_runtime_dependency(%q<google-apis-storage_v1>.freeze, ["~> 0.38"])
  ...
  s.add_development_dependency(%q<google-style>.freeze, ["~> 1.30.0"])
